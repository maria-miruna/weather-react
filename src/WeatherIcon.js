...
export default function WeatherIcon(props) {
  const codeMapping = {
    ...
    "02d": { icon: "PARTLY_CLOUDY_DAY", color: "#B5B2C2" },
    "02n": { icon: "PARTLY_CLOUDY_NIGHT", color: "#B5B2C2" },
    "03d": { icon: "PARTLY_CLOUDY_DAY", color: "#B5B2C2" },
    "03n": { icon: "PARTLY_CLOUDY_NIGHT", color: "#B5B2C2" },
